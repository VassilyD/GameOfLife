class GrapheCanvas {
	...
	dessinerGraphe() {
		...
		this._canvas.stroke();
		if(this._jeu.nbGeneration != 0) {
			this._canvas.lineTo(this._canvasHTML.clientWidth, this._canvasHTML.clientHeight);
			this._canvas.lineTo(0,this._canvasHTML.clientHeight);
			this._canvas.fillStyle = 'rgba(0,60,0,0.2)';
			this._canvas.fill();
		}
		if(this._estFocus) this.dessinerOutils();
	}
